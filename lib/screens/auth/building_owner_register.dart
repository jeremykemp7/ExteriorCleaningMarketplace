...
class BuildingOwnerRegisterScreen extends StatefulWidget {
  ...
  @override
  State<BuildingOwnerRegisterScreen> createState() => _BuildingOwnerRegisterScreenState();
}

class _BuildingOwnerRegisterScreenState extends State<BuildingOwnerRegisterScreen> {
          ...
          actions: [
            TextButton(
              onPressed: () {
                ...
                Navigator.pushReplacementNamed(context, '/login/building-owner');
              },
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Building Owner Registration'),
      ),
